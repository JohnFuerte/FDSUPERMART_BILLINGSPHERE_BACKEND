...
const file = fs.readFileSync('./98C94E69BBC9FACF9B7E3AF1FBACFCAB.txt');
...
app.get('/.well-known/pki-validation/98C94E69BBC9FACF9B7E3AF1FBACFCAB.txt',(req,res)=>{

res.sendFile('/root/FD_SUPER_MART_BACKEND_RENDER/98C94E69BBC9FACF9B7E3AF1FBACFCAB.txt')
